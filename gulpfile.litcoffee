Build core-websocket from source into
build/core-websocket.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/core-websocket.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o core-websocket.html #{__dirname}/build/*.html"
          ])
